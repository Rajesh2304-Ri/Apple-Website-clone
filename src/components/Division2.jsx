...
const SecondDivision = () => {
    ...
    return (
        <section className="relative  md:flex  " >
            <div className="space-y-3 text-center bg-cover bg-center h-[70vh]  w-full md:max-w-full m-2 z-10 " style={{ backgroundImage: `url(${image1})` }} >
            ...
            <div className="  space-y-2 text-center bg-cover bg-center h-[70vh]  w-full   md:max-w-full m-2  " style={{ backgroundImage: `url(${image2})` }} >
